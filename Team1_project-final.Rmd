...
###6. Separating train and test datasets   
...
__We first idenitfied the predictors that are highly correlated with the response variable SalePrice. Then we plotted one of strong predictor GrLivArea against SalePrice and identified two datapoints with both high leverage and influence. In addition, further investigation confirmed that both are presale and likely not reflective their true sale price. We removed these two outliers that have the largest living area (GrLivArea > 4500) and exceptionally low price.__  

```{r, remove two outliers in train dataset, echo=TRUE}
...
#plot Saleprice vs GrLivArea to identify and remoive outliers 
